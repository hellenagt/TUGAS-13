...
<body><CENTER>
	<div style="font-family: arial"><h1>DATA KASUS COVID-19 DENGAN BAR CHART</h1></div>
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					backgroundColor: 'rgba(26, 21, 140, 1)',
